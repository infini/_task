...
void duDebugDrawTriMesh(struct duDebugDraw* dd, const dtCoordinates* verts, int nverts, const int* tris, const dtCoordinates* normals, int ntris, const unsigned char* flags, const float texScale);
void duDebugDrawTriMeshSlope(struct duDebugDraw* dd, const dtCoordinates* verts, int nverts, const int* tris, const dtCoordinates* normals, int ntris, const float walkableSlopeAngle, const float texScale);
